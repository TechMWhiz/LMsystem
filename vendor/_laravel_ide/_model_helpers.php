...
namespace App\Models {
     ...
     * @property mixed $available_copies
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereAuthor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereIsbn($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books wherePublishedDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereAvailableCopies($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereIsAvailable($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books wherePrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Books>|Books query()
     ...
     *
     * @method static \Illuminate\Database\Eloquent\Builder<Borrowing>|Borrowing newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Borrowing>|Borrowing newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Borrowing>|Borrowing query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Borrowing extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property decimal:2 $fine_amount
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereBookId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereBorrowDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereDueDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereReturnDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereFineAmount($value)
